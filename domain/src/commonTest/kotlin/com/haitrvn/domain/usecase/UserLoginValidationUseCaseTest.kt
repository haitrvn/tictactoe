...
class UserLoginValidationUseCaseTest {
    ...
    @Test
    fun `validateUserName - username with invalid characters should return InvalidCharacter error`() = runTest {
    ...
    @Test
    fun `validateUserName - username starting with dot should return InvalidDotPosition error`() = runTest {
        val result = useCase.validateUserName(".username")
    ...
    @Test
    fun `validateUserName - username ending with dot should return InvalidDotPosition error`() = runTest {
        val result = useCase.validateUserName("username.")
    ...
    @Test
    fun `validateUserName - username with consecutive dots should return ConsecutiveDots error`() = runTest {
    ...
    @Test
    fun `validatePassword - password without uppercase should return NoUppercase error`() = runTest {
    ...
    @Test
    fun `validatePassword - password without special character should return NoSpecialCharacter error`() = runTest {
        val result = useCase.validatePassword("Password1")
    ...
    @Test
    fun `validatePassword - password with all requirements except length should return TooShort only`() = runTest {
        val result = useCase.validatePassword("Pass1!")
    ...
    @Test
    fun `validatePassword - long password missing requirements should return specific errors`() = runTest {
